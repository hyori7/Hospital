...
<asp:Content ID="Content2" ContentPlaceHolderID="cnt" runat="server">
	...
	<asp:Button ID="Submit" runat="server" Text="Submit" onclick="onSubmit" CssClass="inputStyle" />
	...
	<input type="button" value="close" onclick="history.go(-1);" style="background-color: #FFFFFF; color: #ccc; 
		font-family: Arial, Helvetica, sans-serif ; font-size: 11px ; border:1px solid #ccc ; padding: 7px ; overflow: hidden ; cursor:pointer;" onfocus="changeColour(this, '#DBDADB')" /></div>
